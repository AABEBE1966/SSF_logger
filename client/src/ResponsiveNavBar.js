...
const pages = ['LoggerSignUp', 'LoggerSignIn', "AdminDataVisualizer", 'LoggerProfile'];
...
const Navbar = ({ menuOpen, setMenuOpen }) => (
  <div className="flex items-center justify-between p-4">
    <div className="flex items-center">
      <FireSvg />
      <a href="/" className="text-xl font-bold no-underline text-gray-800 hover:text-gray-600">SSF</a>
    </div>
